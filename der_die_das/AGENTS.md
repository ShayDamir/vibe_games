...
- After every word a reveal card shows the translation and the gender rule — a rule chip, a red **EXCEPTION** chip, or a red **NO RULE** chip ("memorize it with the article"). Compound words additionally show which word they take the gender of. Space pauses to read.
